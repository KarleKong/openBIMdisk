...
## Usage
You can use the <kbd>clone</kbd> script to download this repository to your local devices.`git clone https://github.com/KarleKong/openBIMdisk`
The recommanded python version is 3.8. To run the openBIMdisk, firstly install the required dependencies through <kbd>pip install -r requirements.txt</kbd>.
